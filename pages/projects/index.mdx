...
### [Textbook Downloader](https://github.com/blekmus/textbook-downloader)
<p>Lead a team to make an application for Georgian College Library staff to make it easier to export digital textbooks</p>
<div className="img-container">![textbook-down](./covers/textbook-down.png)</div>
...
### [Electron-abridged](https://github.com/blekmus/electron-abridged)
<p>Index local anime files in an Electron app.</p>
<div className="img-container">![electron-abridged](./covers/electron-abridged.png)</div>
