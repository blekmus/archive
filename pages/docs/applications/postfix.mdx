...
If you encounter the warning below when checking config. Just act as if you didn't see it. [Source](https://documentation.mailgun.com/en/latest/user_manual.html#smtp-relay)
...
The `535 Authentication Error` usually implies an error in the data we give. May it be a password, a link or the hostname. [Source](https://serverfault.com/questions/1004137/postfix-postfix-script-warning-symlink-leaves-directory-etc-postfix-makedefs)
