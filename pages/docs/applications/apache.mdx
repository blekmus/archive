...
Finally check if everything works fine by popping up a php test file. More info [here](/general/php#testing). Check the Server API field to see if FastCGI is active.

|                  |                   |
| ---------------- | ----------------- |
| Build Date       | -                 |
| __Server API__ | __FPM/FastCGI__ |
| Virtual..        | -                 |
